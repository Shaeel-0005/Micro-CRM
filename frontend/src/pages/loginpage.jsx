        ...
        <div className="max-w-md w-full mx-auto">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            >
              ...
              <a
                href="#"
                className="text-sm font-medium text-[#FF7F40] hover:text-[#E66A2E]"
              >
                Forgot password?
              </a>
            </motion.div>
          ...
          <motion.div variants={fadeInUp} className="relative my-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#FFFCF8] text-gray-500">
                Or continue with
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            <Link
              to="/signup"
              className="text-[#FF7F40] font-medium hover:text-[#E66A2E] underline underline-offset-4"
            >
              Sign up
            </Link>
          </motion.p>
          ...
          <div className="relative h-44 w-full mb-6">
            <div className="absolute inset-0 flex flex-col justify-between pointer-events-none opacity-40">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-full h-px border-t border-dashed border-gray-200"
                ></div>
              ))}
            </div>
