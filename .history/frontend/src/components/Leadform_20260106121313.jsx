            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2.5 text-sm border rounded-lg transition-all outline-none ${
                    errors.name 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 text-sm border border-slate-200 bg-slate-50 rounded-lg transition-all outline-none focus:bg-white focus:ring-2 focus:ring-slate-200 focus:border-transparent"
              ...
              <div>
                ...
                />
                {errors.company && (
                  <p className="text-xs text-rose-600 mt-1.5">{errors.company}</p>
                )}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="w-full px-4 py-2.5 text-sm border border-slate-200 bg-slate-50 rounded-lg transition-all outline-none focus:bg-white focus:ring-2 focus:ring-slate-200 focus:border-transparent cursor-pointer"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={4}
                  className="w-full px-4 py-2.5 text-sm border border-slate-200 bg-slate-50 rounded-lg transition-all outline-none focus:bg-white focus:ring-2 focus:ring-slate-200 focus:border-transparent resize-none"
