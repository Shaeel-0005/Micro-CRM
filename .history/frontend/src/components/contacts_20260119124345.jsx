  ...
  return (
    <div className="flex h-screen overflow-hidden bg-[#FFFCF8]">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Header */}
        <div className="border-b border-gray-100 bg-white px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
              ...
              >
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-3">
                    <div className={`h-12 w-12 rounded-full bg-${contact.color}-100 flex items-center justify-center text-${contact.color}-600 font-semibold`}>
                      {contact.avatar}
                    </div>
                    <div>
