      ...
      >
        ...
        <nav className="flex-1 overflow-y-auto pt-4 sm:pt-6 px-2 sm:px-3 pb-4 sm:pb-6 space-y-1">
          <NavLink
            to="/dashboard"
            className={({ isActive }) =>
              `group flex items-center gap-3 rounded-lg px-3 py-2.5 sm:py-2 text-sm font-medium transition-all ${
                isActive
          ...
          <a
            href="#"
            className="group flex items-center gap-3 rounded-lg px-3 py-2.5 sm:py-2 text-sm font-medium text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all"
          >
            ...
            <div className="bg-gray-50 rounded-xl p-3 space-y-2 border border-gray-100">
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${dropdowns.sales ? "rotate-180" : ""}`}
                  />
                </button>
                {dropdowns.sales && (
                  <div className="pl-9 space-y-1">
                    <a
                      href="#"
                      className="block px-3 py-1.5 text-xs text-gray-600 hover:text-gray-900 rounded-md hover:bg-white"
                    >
                      Pipeline
                    </a>
                    <a
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${dropdowns.activities ? "rotate-180" : ""}`}
                  />
                </button>
              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <ChevronDown
                    className={`h-4 w-4 transition-transform ${dropdowns.integrations ? "rotate-180" : ""}`}
                  />
                </button>
