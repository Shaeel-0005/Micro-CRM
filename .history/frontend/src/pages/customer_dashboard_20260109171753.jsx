...
export default function ThemedDashboard() {
  ...
  const opportunities = [
    { company: 'Acme Corp', desc: 'Enterprise License', stage: 'Negotiation', value: '$45,000', probability: 80, avatar: 'AC', color: 'orange', stageColor: 'orange' },
    { company: 'Stark Tech', desc: 'Q3 Expansion', stage: 'Proposal', value: '$22,500', probability: 60, avatar: 'ST', color: 'orange', stageColor: 'orange' },
    { company: 'Wayne Ltd', desc: 'Consulting', stage: 'Qualified', value: '$12,000', probability: 40, avatar: 'WL', color: 'orange', stageColor: 'amber' },
  ];

  const pipelineStages = [
    { name: 'Discovery', leads: 12, percentage: 30, color: 'gray' },
    { name: 'Proposal', leads: 8, percentage: 45, color: 'orange' },
    { name: 'Negotiation', leads: 5, percentage: 15, color: 'orange' },
  ];
      ...
      <aside className={`fixed lg:relative w-64 h-full flex flex-col border-r border-gray-100 bg-white z-40 transition-transform duration-300 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0`}>
        ...
        <div className="flex h-14 sm:h-16 items-center justify-between px-4 sm:px-6 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <span className="text-base sm:text-lg font-medium tracking-tight text-gray-900">Logo</span>
          </div>
              ...
              <div className="rounded-xl border border-gray-100 bg-white shadow-[0_8px_30px_-8px_rgba(255,127,64,0.15)] overflow-hidden">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-gray-100 px-4 sm:px-6 py-4 gap-2">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-1 hidden sm:block">Deals requiring attention within 7 days</p>
                  </div>
            ...
            <div className="rounded-xl border border-gray-100 bg-white shadow-[0_8px_30px_-8px_rgba(255,127,64,0.15)] h-fit">
              ...
              <div className="p-4 sm:p-6 space-y-4">
                {[
                  ...
                  { action: 'Follow-up scheduled', company: 'Stark Tech', time: '4 hours ago', color: 'orange' },
                  { action: 'Proposal sent', company: 'Wayne Ltd', time: '1 day ago', color: 'orange' },
                ].map((activity, idx) => (
